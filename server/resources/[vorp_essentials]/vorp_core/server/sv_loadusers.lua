    ...
    if #resultList > 0 then
        ...
        if user.banned == true then
            ...
            if bannedUntilTime == 0 then
                ...
                setKickReason("Você está banido permanentemente!")
...
RegisterNetEvent('vorp:playerSpawn', function()
    ...
    if _users[identifier] then
        ...
        if _users[identifier].Numofcharacters() <= 0 then
            ...
            Wait(7000)
            TriggerClientEvent('vorp:NotifyLeft', source, "~e~IMPORTANTE!", Config.Langs.NotifyChar, "minigames_hud",
            ...
            if Config.UseCharPermission then
                ...
                elseif _users[identifier]._charperm == "true" then
                    ...
                    Wait(14000)
                    TriggerClientEvent('vorp:NotifyLeft', source, "~e~IMPORTANTE!", Config.Langs.NotifyCharSelect,
